...
| Server time | 300.00s |
| Server load | 4171.11 |
| Server efficiency | 83.42% |
| Req. count | 126838PUT |
| Req. per second | 422.80PUT/s |
...
| Server time | 64.48s |
| Server load | 0.00 |
| Server efficiency | 0.00% |
| Req. count | 0GET |
| Req. per second | 0.00GET/s |
| Client bandwidth | 0.000MiB/s |
| Client volume | 0.000MiB|
| Client time | 0.00s |
...
| Server time | 100.00s |
| Server load | 1788.01 |
| Server efficiency | 35.76% |
| Req. count | 14706PUT |
| Req. per second | 147.06PUT/s |
| Client bandwidth | 0.000MiB/s |
| Client volume | 0.000MiB|
...
| Server time | 333.09s |
| Server load | 3878.01 |
| Server efficiency | 77.56% |
| Req. count | 126846DELETE |
| Req. per second | 380.81DELETE/s |
| Client bandwidth | 0.000MiB/s |
| Client volume | 0.000MiB|
