...
| C.time/duration | 40.17x |
| PUT count | 48381 |
| PUT per second (avg.) | 161.27PUT/s |
| PUT volume | 47.247MiB|
| PUT test throughput | 0.157MiB/s |
...
| C.time/duration | 38.75x |
| GET count | 9325 |
| GET per second (avg.) | 92.94GET/s |
| GET volume | 9.106MiB|
| GET test throughput | 0.091MiB/s |
...
| C.time/duration | 15.98x |
| PUT count | 5802 |
| PUT per second (avg.) | 57.62PUT/s |
| PUT volume | 5.666MiB|
| PUT test throughput | 0.056MiB/s |
...
| C.time/duration | 23.18x |
| GET count | 5788 |
| GET per second (avg.) | 57.48GET/s |
| GET volume | 5.652MiB|
| GET test throughput | 0.056MiB/s |
...
| C.time/duration | 42.13x |
| DELETE count | 48389 |
| DELETE per second (avg.) | 167.42DELETE/s |
| DELETE volume | 47.255MiB|
| DELETE test throughput | 0.163MiB/s |
