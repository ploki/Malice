...
| PUT count | 6073 |
| PUT per second (avg.) | 20.25PUT/s |
| PUT volume | 189.781MiB|
| PUT workload | 0.633MiB/s |
...
| GET count | 5169 |
| GET per second (avg.) | 51.30GET/s |
| GET volume | 161.531MiB|
| GET workload | 1.603MiB/s |
...
| PUT count | 999 |
| PUT per second (avg.) | 9.95PUT/s |
| PUT volume | 31.219MiB|
| PUT workload | 0.311MiB/s |
...
| GET count | 1045 |
| GET per second (avg.) | 10.41GET/s |
| GET volume | 32.656MiB|
| GET workload | 0.325MiB/s |
...
| DELETE count | 6017 |
| DELETE per second (avg.) | 83.03DELETE/s |
| DELETE volume | 188.031MiB|
| DELETE workload | 2.595MiB/s |
